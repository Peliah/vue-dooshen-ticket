...
import { type Dependency, DependencyType, type EnumValues, type OptionsDependency } from './interface'
    ...
    currentFieldDependencies.value?.forEach((dep) => {
      ...
      switch (dep.type) {
        ...
        case DependencyType.SETS_OPTIONS:
          if (conditionMet)
            overrideOptions.value = (dep as OptionsDependency<z.infer<z.ZodObject<any>>>).options
